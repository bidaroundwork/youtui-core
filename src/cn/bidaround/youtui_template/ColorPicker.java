 ...
 * Use {@link #addSVBar(ColorPickerSVBar)} to add a Saturation/Value Bar. <br>
...
public class ColorPicker extends View {
	 ...
	 */
	private ColorPickerSVBar mSVbar = null;
	...
	private boolean isDrawCusView = false;
	...
	protected void onDraw(Canvas canvas) {
		...
		cusRectF.set(mCenterRectangle.left - 6, mCenterRectangle.top - 6, mCenterRectangle.right + 6, mCenterRectangle.bottom + 6);
	...
	public void setDrawCusView(boolean draw){
		isDrawCusView = draw;
		invalidate();
	}
	
	public RectF getCenterRectangle(){
		return mCenterRectangle;
	}
	 ...
	 */
	public void addSVBar(ColorPickerSVBar bar) {
		mSVbar = bar;
	 ...
	 * 转换成DP
	 */
	public int getDensity(float value) {
