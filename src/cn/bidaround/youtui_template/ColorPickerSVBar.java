...
public class ColorPickerSVBar extends View {
	...
	public ColorPickerSVBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public ColorPickerSVBar(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		mBarThickness = getDensity(30f);
		mBarLength = getDensity(240f);
		mPreferredBarLength = mBarLength;
		mBarPointerRadius = 0;
		mBarPointerHaloRadius = getDensity(30f);
		mOrientation = true;
		...
		mBarPointerHaloPaint.setAlpha(0x00);
	...
	protected void onDraw(Canvas canvas) {
		...
		rectf.set(mBarRect.left - 3, mBarRect.top - 3, mBarRect.right + 3, mBarRect.bottom + 3);
		canvas.drawRect(rectf, cusPaint);
	};
