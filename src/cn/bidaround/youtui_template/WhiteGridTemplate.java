 ...
 * @since 14/6/25
 */
public class WhiteGridTemplate extends YTBasePopupWindow implements OnClickListener, OnPageChangeListener {
	private GridView pagerOne_gridView, pagerTwo_gridView;
	// private ShareGridAdapter pagerOne_gridAdapter, pagerTwo_gridAdapter;
	private TemplateAdapter pagerOne_gridAdapter, pagerTwo_gridAdapter;
	...
	// 每一页包含的分享平台个数
	private final int ITEM_AMOUNT = Integer.MAX_VALUE;
	private TextView cancelBt;

	public WhiteGridTemplate(Activity act, boolean hasAct, YtTemplate template, ShareData shareData, ArrayList<String> enList) {
